...
import com.boz.commons.test.dbunit.DataSetResolver;
...
public class DataSetResolverTest {
  ...
  public void testGetDataSetFileName() {
    assertThat(DataSetResolver.getDataSetFileName(getClass(), null)).isEqualTo(
        "com/boz/commons/test/dbunit/DataSetResolverTest.xml");
